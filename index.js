...
// Time complexity: O(n)
  /* we have to traverse through every element of the array
    so we need at least N time
    where N is the number of elements in the array
    from there, we just execute 1 operation so we can ignore */

// Space complexity: O(1)
  /* we need 1 space for count
    1 space for i
    1 space for animals.length
    regardless of how big the array is,
    we dont need extra space to store any of those values
  */
...
// Count how many animals are in the list
// Time complexity: O(1)
  //array.length is a property we can access instantly
// Space complexity: O(1)
  //we only store 1 variable: animals.length
